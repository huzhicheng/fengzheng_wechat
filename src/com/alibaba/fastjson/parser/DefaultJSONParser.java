...
public class DefaultJSONParser extends AbstractJSONParser implements Closeable {
    ...
    public DefaultJSONParser(final Object input, final JSONLexer lexer, final ParserConfig config){
        ...
        lexer.nextToken(LBRACE); // prime the pump
    }
    ...
    public void parseArray(Type type, Collection array, Object fieldName) {
        if (lexer.token() == SET || lexer.token() == TREE_SET) {
            lexer.nextToken();
        }
        ...
        for (int i = 0; i < types.length; ++i) {
            ...
            if (lexer.token() == NULL) {
                ...
                if (type == int.class || type == Integer.class) {
                    ...
                    // support varArgs
                    if (isArray && lexer.token() != LBRACKET) {
        ...
        for (;;) {
            ...
            if (fieldDeser == null) {
                ...
                if (fieldClass == int.class) {
                    lexer.nextTokenWithColon(LITERAL_INT);
